...
public class PlayerStatsViewer extends JLayeredPane {
	...
	private void initialize() throws FontFormatException, IOException {
		...
		lblNewLabel_4_2.setBounds(500, 515, 295, 60);
		...
		lostlbl.setBounds(624, 432, 48, 36);
		this.add(lostlbl);
